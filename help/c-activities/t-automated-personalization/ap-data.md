...
|Experience Cloud segment|Audiences created in Audience Manager or Analytics and shared across the Experience Cloud|`Custom - Experience Cloud Audience - [Audience Name]`|This is a set of Number → "1" values.<br>Number is the Adobe Audience Manager (AAM) segment ID.|
